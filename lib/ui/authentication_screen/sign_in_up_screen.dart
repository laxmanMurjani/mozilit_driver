    ...
    showDialog(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            ...
            title: Text(
              "Mozilit driver would like to collect location data to enable your current location to provide you the service for taxi booking and navigation even when the app is closed or not in use.",
