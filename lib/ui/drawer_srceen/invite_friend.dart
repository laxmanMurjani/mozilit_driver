                          ...
                          children: [
                            ...
                            InkWell(
                              onTap: () {
                                print("smdh");
                                String s =
                                    "Hey Checkout this app, Mozilit - https://play.google.com/store/apps/details?id=com.mozilitdemo.user Provider - https://play.google.com/store/apps/details?id=com.mozilitdemo.provider.\nInstall this app with referral code ${cont.userData.value.referralUniqueId ?? ""}";
